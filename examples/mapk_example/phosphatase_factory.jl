...
function phosphatase_factory!(BG, name; KMP = 1.0, KE = 1.0)
    ...
    add_1J!(
        BG,
        Dict(S(name * "B1") => true, S(name * "B2") => false, S(name * "MP") => true),
        S(name * "J_MP"),
    )
    add_1J!(
        BG,
    ...
    add_0J!(
        BG,
        Dict(S(name * "B3") => true, S(name * "C") => false, S(name * "B4") => false),
        S(name * "J_C"),
    )
    add_0J!(
        BG,
        Dict(S(name * "B6") => true, S(name * "B1") => false, S(name * "E") => false),
        S(name * "J_E"),
    )
